...
public class MainDAO {
	...
	public  int checkemail(String admin_email,int from,String participantid)
	{
		...
		try{
	      ...
	      if(from==0)
	       	     cmd_emaillist="Select count(*) as counting from login where email_id='"+admin_email+"'";
	      else if(from==1)
	    	  cmd_emaillist="Select count(*) as counting from participants_table where email_id='"+admin_email+"' and username!='"+participantid+"'";

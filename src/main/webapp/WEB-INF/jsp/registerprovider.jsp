    ...
    <table cellpadding="0" cellspacing="0" border="0" width="98%" class="margin_table">
      ...
      <tr>
		...
		<tr class="row1">
                ...
                <tr class="row2">
                  <td valign="middle" align="right" class="input_txt"><span class="err">*</span> E-mail :</td>
                  <td valign="top" align="left" class="input_txt"><input type="text" name="admin_email" class="input_txtbx" id="inp_id4" value="${admin.admin_email}" /><br><span class="err"><font color="Red" size="+1"><c:if test="${email_exist==true}"><c:out value="Email Id  already exist"/></c:if><form:errors path="adminuser.admin_email"></form:errors></span></td>
                </tr>
